        ...
        <main class="main-content">
            <div class="assignment-container">
                ...
                <div class="assignment-content">
                    ...
                    <p>You have already been assigned to Room <strong>${requestScope.assignedRoomId}</strong>. There is no need to apply for another room assignment at this time.</p>
                </div>
                    
                    <div class="room-details">
                        <div class="detail-card">
                            <h4>Room Information</h4>
                            <p><strong>Room ID: ${requestScope.assignedRoomId}</strong> </p>
                            <p><strong>Block: </strong>${requestScope.assignedBlockName}</p>
